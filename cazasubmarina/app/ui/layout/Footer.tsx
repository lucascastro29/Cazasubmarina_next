...
export default function Page() {
  return (
    <footer className="bg-white dark:bg-gray-900" style={{ backgroundColor: "#0b0b0c" }}>
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-5 ">
            ...
            <div className="h-full grid content-end">
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <Link href="/Equipos" className="hover:underline">
                  EQUIPOS
                </Link>
              </ul>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          href={"https://api.whatsapp.com/send/?phone=59899606606&text&type=phone_number&app_absent=0"}
            ...
            <Link href="https://www.instagram.com/websuy.com.uy/" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"

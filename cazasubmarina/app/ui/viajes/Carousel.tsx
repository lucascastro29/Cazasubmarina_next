  ...
  return (
    <div className="relative w-full h-64 overflow-hidden rounded-lg shadow-lg">
      <div className="absolute inset-0 flex transition-transform transform">
        <Image className="w-full h-full object-cover" height={10} width={10} src="" alt="Travel 1" />
        <Image className="w-full h-full object-cover" height={10} width={10} src="" alt="Travel 2" />
        <Image className="w-full h-full object-cover" height={10} width={10} src="" alt="Travel 3" />
      </div>

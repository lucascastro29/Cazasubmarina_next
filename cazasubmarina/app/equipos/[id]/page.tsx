    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden m-14">
        <div className="grid grid-cols-2">
          ...
          <div className=" p-8">
            <h2 className="text-3xl text-gray-900 mb-4 "  style={{borderBottom:"solid black 3px",fontSize:"25px",paddingBottom:"2px"}}><strong>{product.name}</strong></h2>

            
            <p className="text-xl text-gray-600 leading-relaxed">
              {product.description }
            </p>
            <div className="grid grid-cols-2 content-end gap-4 place-content-start h-48">
            <div className='container'>
              <Link
          href={"https://api.whatsapp.com/send/?phone=59899606606&text&type=phone_number&app_absent=0"}
                target="_blank"
                className="inline-flex shadow items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-green-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">          
    <span className="w-fit">¿ESTAS INTERESADO EN EL EQUIPO?</span>
